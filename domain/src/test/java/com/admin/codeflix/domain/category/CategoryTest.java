...
import com.admin.codeflix.domain.validation.handler.ThrowsValidationHandler;
...
public class CategoryTest {
    ...
    public void givenAnInvalidNameLengthMoreThan255_whenCallNewCategoryAndValidate_thenShouldReceiveError() {
        ...
        final String expectedName = "Augusto Filho Guilherme Paulo João Augusto Filho Guilherme Paulo João Augusto Filho Guilherme" +
                " Paulo João Augusto Filho Guilherme Paulo João Augusto Filho Guilherme Paulo João Augusto Filho Guilherme Paulo" +
                " João Augusto Filho Guilherme Paulo João Augusto Filho Guilherme Paulo João.";
    ...
    public void givenAValidActiveCategory_whenCallDeactivate_thenReturnCategoryInactivated() {
        ...
        final var updatedAt = aCategory.getUpdatedAt().minusSeconds(1);
